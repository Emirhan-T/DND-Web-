...
const gameSchema = new mongoose.Schema({
    ...
    // Hex-grid taktik harita verisi (hexes, objects, tokens, background vb.)
    // Yapı: src/Components/HexMap/hexUtils.js -> buildMapJson()
    // Gelecekte AI tarafından üretilen harita JSON'ı da buraya yazılabilir.
    map: {
        type: mongoose.Schema.Types.Mixed,
        default: null
    }
